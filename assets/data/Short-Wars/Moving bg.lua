...
sprite = 'stageback5' --name of the image you want moving in the background
size = 2000 --number of pixels from left to right
startX = -400 --where you want it to be from left to right
startY = -200 --where you want it to be from bottom to top
