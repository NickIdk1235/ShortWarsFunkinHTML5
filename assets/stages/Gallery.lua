...
function onCreate()
	...
	addArt('First Screen Shot Of SWF','First Screen Shot Of SWF','A9A9A9',5,3)
	addArt('e','Making Of Riggys From The Old Version','FFA500',5,3)
	addArt('First','Captains Foxs Original Concept That Gave The Mod Idea','2F4F4F',5,3)
	addArt('f','First Gameplay Of The Mod','2F4F4F',5,3)
	addArt('Pizdec','CANON','2F4F4F',5,3)
	addArt('PLUSHIE','Vennexxy Freaking Out Over The Riggy Plush She Bought','2F4F4F',5,3)
